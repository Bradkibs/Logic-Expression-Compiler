...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NOT = 6,                        /* NOT  */
  YYSYMBOL_XOR = 7,                        /* XOR  */
  YYSYMBOL_XNOR = 8,                       /* XNOR  */
  YYSYMBOL_IMPLIES = 9,                    /* IMPLIES  */
  YYSYMBOL_IFF = 10,                       /* IFF  */
  YYSYMBOL_EQUIV = 11,                     /* EQUIV  */
  YYSYMBOL_EXISTS = 12,                    /* EXISTS  */
  YYSYMBOL_FORALL = 13,                    /* FORALL  */
  YYSYMBOL_IF = 14,                        /* IF  */
  YYSYMBOL_IFF_KEYWORD = 15,               /* IFF_KEYWORD  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "IDENTIFIER", "AND",
  "OR", "NOT", "XOR", "XNOR", "IMPLIES", "IFF", "EQUIV", "EXISTS",
  "FORALL", "IF", "IFF_KEYWORD", "ASSIGN", "LPAREN", "RPAREN", "$accept",
...
{
      66,   -12,    68,    10,    11,    68,    22,   -13,     1,    68,
     -13,   -13,     9,    12,    33,   -13,   -13,    68,    68,    68,
      68,    68,    68,    68,     1,    68,    68,   -13,   -13,    23,
      -3,    -3,    82,    82,    82,    45,    57,   -13,   -13
};
...
static const yytype_int8 yydefact[] =
{
       0,     6,     0,     0,     0,     0,     0,     2,     5,     0,
       6,     7,     0,     0,     0,     1,     3,     0,     0,     0,
       0,     0,     0,     0,     4,     0,     0,    17,     8,     9,
      10,    11,    12,    13,    14,     0,     0,    15,    16
};
...
{
      11,    17,    18,    14,     9,    17,    18,    24,    19,    20,
      21,    22,    23,    12,    13,    28,    29,    30,    31,    32,
      33,    34,    15,    35,    36,     1,    25,    17,     2,    26,
      16,     0,     0,     0,     3,     4,     0,    17,    18,     5,
      19,    20,    21,    22,    23,     0,     0,     0,     0,    17,
      18,    27,    19,    20,    21,    22,    23,     0,     0,     0,
       0,    17,    18,    37,    19,    20,    21,    22,    23,     1,
       0,    10,     2,     0,     2,    38,     0,     0,     3,     4,
       3,     4,     0,     5,     0,     5,    17,    18,     0,    19,
      20,    21
};

static const yytype_int8 yycheck[] =
{
       2,     4,     5,     5,    16,     4,     5,     9,     7,     8,
       9,    10,    11,     3,     3,    17,    18,    19,    20,    21,
      22,    23,     0,    25,    26,     3,    17,     4,     6,    17,
       6,    -1,    -1,    -1,    12,    13,    -1,     4,     5,    17,
       7,     8,     9,    10,    11,    -1,    -1,    -1,    -1,     4,
       5,    18,     7,     8,     9,    10,    11,    -1,    -1,    -1,
      -1,     4,     5,    18,     7,     8,     9,    10,    11,     3,
      -1,     3,     6,    -1,     6,    18,    -1,    -1,    12,    13,
      12,    13,    -1,    17,    -1,    17,     4,     5,    -1,     7,
       8,     9
};
...
{
       0,     3,     6,    12,    13,    17,    20,    21,    22,    16,
       3,    22,     3,     3,    22,     0,    21,     4,     5,     7,
       8,     9,    10,    11,    22,    17,    17,    18,    22,    22,
      22,    22,    22,    22,    22,    22,    22,    18,    18
};
...
#line 1107 "./C_Components/parser.c"
    break;

  case 5: /* statement: expr  */
#line 39 "parser.y"
                                  { (yyval.node) = (yyvsp[0].node); }
#line 1113 "./C_Components/parser.c"
    break;
...
#line 1189 "./C_Components/parser.c"
